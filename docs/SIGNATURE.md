...
>
> - **Distribuer dès maintenant, gratuitement** : certificat auto-signé + approbation par
>   l'installateur dans le magasin de l'utilisateur → **[`CERTIFICAT_AUTOSIGNE.md`](CERTIFICAT_AUTOSIGNE.md)**
>   (mode **retenu** actuellement, vérifié en Sandbox).
> - **Distribuer avec un vrai certificat d'AC** : Certum « Open Source Code Signing in the
>   Cloud », 49 € / 58 $ par an, sans matériel → **[`CERTUM.md`](CERTUM.md)**
>   (⏸️ en pause par décision utilisateur). Comparatif des autres pistes (SignPath
>   Foundation, Azure Artifact Signing, EV…) : **[`CERTIFICAT_OPENSOURCE.md`](CERTIFICAT_OPENSOURCE.md)**.
>
> Ce qui suit ne concerne que le **test du pipeline** avec un certificat auto-signé.
